...
/// @dev Math helpers for a classic constant product (xyk) pool.
/// @author Modified from Uniswap V2 (https://github.com/Uniswap/v2-core/tree/master/contracts/libraries)
/// @author Modified from Solady (https://github.com/Vectorized/solady/blob/main/src/utils/FixedPointMathLib.sol)
library Math2 {
    /// @dev Placeholder constant.
